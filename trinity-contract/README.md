...
| 项目 | 内容 |
|------|------|
| 模块名称 | Trinity Contract |
| Maven Artifact | `com.trinity:trinity-contract` |
| 端口 | 8095 |
| 所属层级 | 财务管控层 |
...
合同管理服务，负责公司各类合同的全生命周期管理：
- **合同类型**：采购合同、服务合同、租赁合同等类型定义
- **合同录入**：合同基本信息、条款、附件上传
- **审批流程**：合同审批、会签、用印申请
- **履约跟踪**：付款节点、交付节点跟踪
- **到期提醒**：合同到期自动提醒续签/终止
...
trinity-auth（权限校验）、trinity-org（签约主体）、trinity-payment（合同付款计划关联）
